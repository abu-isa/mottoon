  ...
  <div class="row">
    <div class="col-md-6">
      <div class="tile">
        ...
        <p>Vali is is light-weight, expendable and good looking theme. The theme has all the features required in a dashboard theme but this features are built like plug and play module. Take a look at the <a href="#" target="_blank">documentation</a> about customizing the theme colors and functionality.</p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="tile">
