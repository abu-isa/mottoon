...
@section('title', '.:MOTTOON - TAMBAH DATA MARHALAH:.')
@section('container')
              ...
              @csrf
                ...
                <div class="form-group">
                    ...
                    @foreach( $books as $book ) 
                      <option value="{{ $book->id }}"> {{ $book->kitab }}</option>
                    @endforeach
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" type="text" name="keterangan" value="{{ old('keterangan') }}" placeholder="Masukan keterangan">
                  @error('keterangan')
                  <div class="form-control-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                &nbsp;&nbsp;&nbsp;
                <a class="btn btn-secondary" href="/sections">
