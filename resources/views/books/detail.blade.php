...
@section('title', '.:MOTTOON - DETAIL KITAB:.')
@section('container')
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              ...
              <div class="btn-group">
                <a class="btn btn-primary" href="/books/create"><i class="fa fa-lg fa-plus"></i></a>
                <a class="btn btn-primary" href="/books/{{ $book->id }}/edit"><i class="fa fa-lg fa-edit"></i></a>
            ...
            <div class="tile-body">
              <b>Nama Kitab  : {{ $book->kitab }} </b><br>
              Pengarang : {{ $book->pengarang }}<br>
            </div>
            <br/>
            <a href="/books" class="btn btn-primary btn-sm">Back</button></a>  
